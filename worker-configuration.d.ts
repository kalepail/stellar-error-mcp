/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b2c908f05579e31717d590b929eb222f)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		AI: Ai;
		STELLAR_ARCHIVE_RPC_ENDPOINT: "https://archive-rpc-pro.lightsail.network";
		STELLAR_RPC_ENDPOINT: "https://rpc-pro.lightsail.network";
		STELLAR_RPC_AUTH_MODE: "header";
		AI_SEARCH_INSTANCE: "stellar-errors";
		AI_SEARCH_MODEL: "@cf/meta/llama-3.3-70b-instruct-fp8-fast";
		AI_ANALYSIS_MODEL: "@cf/moonshotai/kimi-k2.5";
		DIRECT_ERROR_WORKFLOW: Workflow<Parameters<import("./src/index").DirectErrorWorkflow['run']>[0]['payload']>;
		LEDGER_RANGE_WORKFLOW: Workflow<Parameters<import("./src/index").LedgerRangeWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STELLAR_ARCHIVE_RPC_ENDPOINT" | "STELLAR_RPC_ENDPOINT" | "STELLAR_RPC_AUTH_MODE" | "AI_SEARCH_INSTANCE" | "AI_SEARCH_MODEL" | "AI_ANALYSIS_MODEL">> {}
}
